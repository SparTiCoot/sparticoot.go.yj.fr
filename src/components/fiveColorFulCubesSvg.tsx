...
export const FiveColorFulCubesSvg = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width="15vw"
    viewBox="0 0 365 294"
    fill="none"
  ...
  >
    ...
    <g id="animated-red-cube">
      <path d="M282 119L363 167L323 189.5L244 141L282 119Z" fill="#972326" />
      <path
...
export { FiveColorFulCubesSvg as ReactComponent };
